...
// Updated Sri Lankan franchises from the PDF document
const srilankanFranchises = [
  { name: "Mrs. Shiyamala Kannan", location: "Kotahena", phone: "0776979530" },
  { name: "Mrs. Buela Jeganathan", location: "Mattakkuliya", phone: "0776303663" },
  { name: "Mrs. Mary Ann Dharshini", location: "Hatton / Maskeliya / Nuware Eliya", phone: "0777217928" },
  { name: "Mr. Ameen Irshad", location: "Sammanthurai", phone: "0778484238" },
  { name: "Mrs. Anne Florida Missier", location: "Wattala", phone: "0767248805" },
  { name: "Mrs. Fathima Asma Hanilf", location: "Dematagoda", phone: "0765721027" },
  { name: "Mrs. Nuzrath Majitha Farhan", location: "Badulla / Bandarawela", phone: "0761617373" },
  { name: "Mrs. Freeda Anthonraj", location: "Norwood", phone: "0765642488" },
  { name: "Mrs. Sudarshani Kishanth Ragul", location: "Kotagala / Thalawakelle / Akurana", phone: "0743590777" },
  { name: "Mrs. Nisanthini Thirumurugan", location: "Nawalapitiya", phone: "0766706921" },
  { name: "Mrs. Abilashini Visvanathan", location: "Avissawella", phone: "0769425625" },
  { name: "Mrs. Jesliya Imthiyaz", location: "Sammanthurai West", phone: "0773538173" },
  { name: "Mrs. Abdul Hakeem Nasreen Banu", location: "Akkariapattu", phone: "0774666196" },
  { name: "Miss. Sivaganam Kalaipriya", location: "Attampitiya", phone: "0702371932" },
  { name: "Mr. Niyaz", location: "Kinniya", phone: "0777481647" },
  { name: "Mr. Mohamed Nafty", location: "Ampara", phone: "" },
].filter(f => f.phone !== "") // Filter out entries without phone numbers
...
const countryContacts = [
  ...
  },
  {
    ...
    flag: "🇮🇳",
    name: "Mrs.K.Ajitha",
    address: "495/c.sai children's academy near abi mahal, palaniroad,oddanchatram, Dindigul district, Tamilnadu.",
    phone: "9841735034",
  ...
  },
  {
    ...
    flag: "DK",
    name: "Mr.Charles",
    address: "Tagensvej 180,32200 kobenhavn, Denmark.",
    phone: "+45 81 88 7034",
  ...
  return (
    <>
      ...
      <div className="pt-20 bg-white">
        ...
        {/* Franchisee Review Section - NEW */}
        <section className="py-16 md:py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
          {/* Background decoration */}
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-20 right-20 w-64 h-64 bg-teal-100/50 rounded-full blur-3xl" />
            <div className="absolute bottom-20 left-20 w-64 h-64 bg-amber-100/50 rounded-full blur-3xl" />
          </div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-brown mb-4">What Our Partners Say</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Hear from our dedicated franchisees who are making a difference in children's lives across the island
              </p>
            </motion.div>
            ...
            >
              {/* Main Review Card */}
              <Card className="rounded-3xl border-2 border-teal-100 bg-white shadow-2xl overflow-hidden">
                <div className="grid md:grid-cols-5">
                  {/* Quote/Image Section */}
                  <div className="md:col-span-2 bg-gradient-to-br from-teal-600 to-emerald-700 p-8 md:p-10 flex flex-col items-center justify-center text-white relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-10 -mt-10" />
                    <div className="absolute bottom-0 left-0 w-40 h-40 bg-black/10 rounded-full -ml-20 -mb-20" />
                    
                    <Quote className="w-16 h-16 text-white/30 mb-4" />
                    <h3 className="text-2xl font-bold text-center mb-2">HOMAC Institute</h3>
                    <p className="text-teal-100 text-center text-sm">of Abacus</p>
                    ...
                    <div className="mt-8 flex items-center gap-2 text-teal-100 text-sm">
                      <MapPin className="w-4 h-4" />
                      <span>Island-wide Presence</span>
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-3 p-8 md:p-10">
                    <div className="relative">
                      <Quote className="absolute -top-2 -left-2 w-8 h-8 text-teal-200 rotate-180" />
                      <p className="text-gray-700 text-lg leading-relaxed mb-6 pl-6 relative z-10">
                        HOMAC Institute of Abacus is a trusted island-wide abacus institute, and being part of this 
                        respected organization has been a truly inspiring journey for me.
                      </p>
                      
                      <p className="text-gray-600 mb-4 pl-6">
                        I am proud to serve as a HOMAC teacher for three branches—Kotagala, Talawakelle, and Akurana—under 
                        Smart Friend Academy. Through HOMAC, I have been able to guide many children towards not only 
                        academic improvement, but also greater confidence, concentration, and self-belief.
                      </p>
                      
                      <p className="text-gray-600 mb-4 pl-6">
                        HOMAC's strong curriculum, clear teaching methods, and continuous guidance give teachers the 
                        confidence to deliver the best to every student. Watching children overcome their fear of numbers 
                        and grow with enthusiasm is the most rewarding part of this journey.
                      </p>
                      
                      <p className="text-gray-600 mb-6 pl-6 font-medium">
                        HOMAC is more than an institute—it is a family that supports teachers and nurtures students across 
                        the island. I am grateful to be a part of this meaningful mission and look forward to contributing 
                        to the growth of many more young minds in the future.
                      </p>
                      
                      <div className="border-t border-gray-100 pt-6 mt-4 pl-6">
                        <p className="font-bold text-gray-900 text-lg">Sudarshani. K. Ragul</p>
                        <p className="text-teal-600 font-medium">Teacher – HOMAC Institute of Abacus</p>
                        <p className="text-gray-500 text-sm mt-1">Smart Friend Academy</p>
                        <p className="text-gray-400 text-xs flex items-center gap-1 mt-1">
                          <MapPin className="w-3 h-3" /> Kotagala | Talawakelle | Akurana
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              {/* Decorative elements */}
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-amber-100/50 rounded-full blur-2xl -z-10" />
              <div className="absolute -top-4 -left-4 w-24 h-24 bg-purple-100/50 rounded-full blur-2xl -z-10" />
            </motion.div>
            
            {/* Stats from franchisee network */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              {[
                { number: "50+", label: "Franchise Locations" },
                { number: "100+", label: "Dedicated Teachers" },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <span className="inline-block px-4 py-2 bg-teal-50 text-teal-700 rounded-full text-sm font-medium">
                Total: {srilankanFranchises.length} Active Franchise Partners
              </span>
            </motion.div>
          </div>
        </section>
              ...
              <form
                ...
                onSubmit={async (e) => {
                  ...
                  const data = {
                    ...
                    investmentAmount: "Pending discussion",
