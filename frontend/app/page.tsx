  ...
  const [data, setData] = useState([
{
  ...
  const branches = [
    ...
    { name: "Sri lanka", flagUrl: "https://flagcdn.com/w160/lk.png", code: "LK" },
      {
    name: "Denmark",
  ...
  const stats = [
    ...
    { value: "5", label: "Countries with HOMAC presence", icon: Globe, bgColor: "bg-rose-500" },
...
<section className="py-16 md:py-24 bg-gradient-to-b from-rose-50/50 to-background relative overflow-hidden">
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="relative max-w-3xl mx-auto">
      <motion.div
        className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border-2 border-rose-100 relative text-center"
        animate={{ y: [0, -5, 0] }}
        transition={{ repeat: Number.POSITIVE_INFINITY, duration: 4 }}
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="relative w-full h-full">
              <img  src="/images/chilabacus.jpg"
              alt="HOMAC UK YouTube Channel"
              className="w-full h-full object-cover"/>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  onClick={() => window.open(`https://youtube.com/@homacuk?si=A3dWhl2SiwxbRItr${featuredVideo.id}`, '_blank')}
                >
