...
export function Footer() {
  const socialLinks = [
    { icon: Facebook, href: "https://www.facebook.com/profile.php?id=61586943599074", label: "Facebook" },
    { icon: Instagram, href: "https://www.instagram.com/homac_uk/", label: "Instagram" },
    { icon: Twitter, href: "#", label: "Twitter" },
    { icon: Youtube, href: "https://www.youtube.com/feed/you", label: "YouTube" },
  ]
